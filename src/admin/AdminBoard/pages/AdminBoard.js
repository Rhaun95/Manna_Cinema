...
import "../css/AdminBoard1.css";
import Pagination_B from "../components/Pagination_B";
...
function Board() {
  ...
  return (
    <>
      <div className="board_container_main1">
        <div className="board_wrap_all" style={{marginTop : '4em',marginLeft : '30em', height : '100vh'}} >
